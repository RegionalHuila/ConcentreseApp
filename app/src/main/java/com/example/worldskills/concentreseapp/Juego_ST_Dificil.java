...
public class Juego_ST_Dificil extends AppCompatActivity implements View.OnClickListener {

    ArrayList<Integer> arregloImagenes = new ArrayList<Integer>();
    ImageView iv00, iv01, iv10, iv11, iv20, iv21, iv30, iv31, iv40, iv41, iv50, iv51, iv60, iv61, iv70, iv71, imgTemporal1, imgTemporal2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego__st__dificil);
        //INSTANCIO VARIABLES
        ...
        iv70 = (ImageView)findViewById(R.id.iv70);
    ...
    private void arregloImagenes() {
        ...
        arregloImagenes.add(R.drawable.bart);
        arregloImagenes.add(R.drawable.tony);
        arregloImagenes.add(R.drawable.tony);
        arregloImagenes.add(R.drawable.magie);
        arregloImagenes.add(R.drawable.magie);
    ...
    private void asignarImagenes() {
        ...
        iv60.setTag(asignarImagenesAleatorias());
        iv61.setTag(asignarImagenesAleatorias());
        iv70.setTag(asignarImagenesAleatorias());
        iv71.setTag(asignarImagenesAleatorias());
    }
